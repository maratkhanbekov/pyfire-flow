...
def upload_deck_media_files():
    path_from_current_folder_to_contents = '../../shared-decks/media/city-life/'
    shared_decks = SharedDeck(content_file_path=f'{path_from_current_folder_to_contents}content.xlsx')
    destination_path = 'shared-decks/city-life-v1/'
...
def upload_deck_content(destination_path, scale_mode=False):
    ...
    deck_instance['title'] = 'Learn English: Top 250 words of city-life'
    deck_instance['colorHex'] = flashcards_firestore_schemes.colors['Greens'][0]
