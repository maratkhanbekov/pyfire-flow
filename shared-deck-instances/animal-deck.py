...
def upload_deck_media_files():
    ...
    path_from_current_folder_to_contents = '../../shared-decks/media/animals/'
    shared_decks = SharedDeck(content_file_path=f'{path_from_current_folder_to_contents}contents.xlsx')
    destination_path = 'shared-decks/animals-v1/'
...
def upload_deck_content(destination_path, scale_mode=False):
    # Generate content
    path_from_current_folder_to_contents = '../../shared-decks/media/animals'
    shared_deck = SharedDeck(content_file_path=f'{path_from_current_folder_to_contents}/content-spanish.xlsx')
    ...
    deck_instance['cards'] = shared_deck.generate_cards_with_image_on_front_side()
